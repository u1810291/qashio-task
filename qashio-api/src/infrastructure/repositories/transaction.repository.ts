...
@Injectable()
export class DatabaseTransactionRepository extends PrismaRepository<'transaction'> implements TransactionRepositoryI {
  constructor(
  ...
  async updateTransaction(id: string, data: Transaction): Promise<string | null> {
  ...
  async getAllTransactions(options: Record<string, number>): Promise<Transaction[]> {
